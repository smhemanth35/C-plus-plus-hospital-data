...
public:Employee(const string name, int id) : Person(name) , employeeId(id) {} 
...
public:Student(const string name, int id) : Person(name) , studentId(id) {} 
	void displayStudent() 
	{ 
		display(); 
...
{ 
public:StudentIntern(const string name, int empId, int stuId): Employee(name, empId) , Student(name, stuId) { } 
